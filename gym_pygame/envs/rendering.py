# Adapted from: https://github.com/openai/gym/blob/v0.21.0/gym/envs/classic_control/rendering.py
"""
...
def get_display(spec):
  ...
  if spec is None:
    ...
    raise Exception(f"Invalid display specification: {spec}. (Must be a string like :0 or None.)")
